...
(function ($) {
    ...
    function a(error, inputElement) {  // 'this' is the form element
    ...
    function onError(error, inputElement) {  // 'this' is the form element
        ...
        if (error.text().length > 0) {
            if ($("[popupfor='" + inputElement[0].name + "']").length == 0) {
                $(document.body).append("<div class=\"poptip\" popupfor=\"" + inputElement[0].name + "\" style=\"top: " + (pos.top + inputElement.height()) + "px;left:" + pos.left + "px;\"><span class=\"poptip-arrow poptip-arrow-top\"><em>¡ô</em><i>¡ô</i></span>" + error.text() + "</div>");
            }
            else {
