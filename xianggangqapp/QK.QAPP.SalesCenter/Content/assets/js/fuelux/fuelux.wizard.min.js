(function (b, c) {
    var a = function (f, e) {
        ...
        this.currentStep = $(".form-horizontal[data-readonly='False']").closest(".step-pane").first().addClass("active").index() + 1;
        ...
        constructor: a, setState: function () {
            ...
            if (d) {
                if (trigger == undefined || trigger == true) {
                    ...
                    this.$element.trigger(f, { step: this.currentStep, direction: "previous", obj: this, triggerName: "previous" });
                    if (f.isDefaultPrevented()) {
                        return
                    }
                }
            ...
            if (g) {
                if (trigger == undefined || trigger == true) {
                    var f = b.Event("change");
                    this.$element.trigger(f, { step: this.currentStep, direction: "next", obj: this, triggerName: "next" });
                    if (f.isDefaultPrevented()) {
                        return
                    }
                }
