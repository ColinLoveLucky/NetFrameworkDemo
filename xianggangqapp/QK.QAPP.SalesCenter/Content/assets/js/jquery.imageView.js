        ...
        function loaded() {
            ...
            $(document).bind('mousemove.imgview', function (event) {
                if ($img.data('mousedown')) {
                    ...
                    var containerX = $container[0].offsetLeft;
                    var containerY = $container[0].offsetTop;
                    var containerW = $container[0].offsetWidth;
                    var containerH = $container[0].offsetHeight;
                    if (mouseX < containerX || (containerX + containerW) < mouseX || mouseY < containerY || (containerY + containerH) < mouseY) {
                        $(document).mouseup();
                        return false;
                    }
