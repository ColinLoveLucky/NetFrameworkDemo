...
namespace QK.QAPP.Entity
{
    ...
    public partial class PRE_APP_STAFF_ONLY : BasicEntity
    {
         public PRE_APP_STAFF_ONLY(): base(false){ }
         public PRE_APP_STAFF_ONLY(bool isGenerated = false) : base(isGenerated) { }
            
    	 [Sequence("SEQ_PRE_APP_STAFF_ONLY")]
